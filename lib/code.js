...
(function (what) {
    class panel_UTXO {
        ...
        refresh() {
            return __awaiter(this, void 0, void 0, function* () {
                var Nep5 = yield what.WWW.rpc_getBalanceOf(this.main.panelState.chainHash, this.main.panelLoadKey.address);
        ...
        update() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (height > what.WWW.blockHeight) {
                    ...
                    what.AppChainTool.initAllAppChain();
...
(function (what) {
    ...
    WWW.api = "http://115.159.53.39:20332/";
